  ...
  useEffect(() => {
    ...
    if (catId) {
      getDocs(queryCollection)
        ...
        .then((respuestaAceptado) =>
          setProducts(
            respuestaAceptado.filter((catego) => catego.clas === catId)
          )
        )
        ...
        <div className="row">
          <div className="col-lg-12">
            <ParrafosTexto
              ...
              txt="Esperamos que encuentres algo que te agrade. :)"
            />
          </div>
        </div>
        <div className="row">
          {cargando ? (
            <h4 className="btn btn-danger">Cargando productos...</h4>
          ) : (
